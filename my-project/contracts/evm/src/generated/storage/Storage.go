...
type StorageCodec interface {
	EncodeGetMethodCall() ([]byte, error)
	DecodeGetMethodOutput(data []byte) (*big.Int, error)
...
func (c *Codec) EncodeGetMethodCall() ([]byte, error) {
	return c.abi.Pack("get")
}

func (c *Codec) DecodeGetMethodOutput(data []byte) (*big.Int, error) {
	vals, err := c.abi.Methods["get"].Outputs.Unpack(data)
	if err != nil {
...
func (c Storage) Get(
	...
	calldata, err := c.Codec.EncodeGetMethodCall()
	if err != nil {
	...
	return cre.Then(promise, func(response *evm.CallContractReply) (*big.Int, error) {
		return c.Codec.DecodeGetMethodOutput(response.Data)
	})

}

func (c Storage) Value(
	runtime cre.Runtime,
	blockNumber *big.Int,
) cre.Promise[*big.Int] {
